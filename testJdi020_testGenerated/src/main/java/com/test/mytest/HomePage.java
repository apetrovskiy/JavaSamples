...
// http://www.fifa.com/
    ...
    @FindBy(className="dcm-title")
    public ILabel labelJonesBigplayerslikebiggames;

    @FindBy(linkText="Jones: Big players like big games")
    public ILink linkJonesBigplayerslikebiggames;
    ...
    @FindBy(className="dcm-title")
    public ILabel labelKiralyImakeepernotamodel;

    @FindBy(linkText="Kiraly: IвЂ™m a keeper, not a model")
    public ILink linkKiralyImakeepernotamodel;
    ...
    @FindBy(className="dcm-title")
    public ILabel labelHaitiatthe1974FIFAWorldCup;

    @FindBy(linkText="Haiti at the 1974 FIFA World Cup")
    public ILink linkHaitiatthe1974FIFAWorldCup;
    ...
    @FindBy(className="dcm-title")
    public ILabel labelRomania11SwitzerlandUEFAEURO2016;

    @FindBy(linkText="Romania 1-1 Switzerland (UEFA EURO 2016)")
    public ILink linkRomania11SwitzerlandUEFAEURO2016;

    @FindBy(className="dcm-newsitemlink")
    public ILink linkgoogleoffindexRussia2018googleonindexKharbinWewanttoputasmileonSyrianfaces;

    @FindBy(className="dcm-title")
    public ILabel labelKharbinWewanttoputasmileonSyrianfaces;

    @FindBy(className="dcm-newsitemlink")
    public ILink linkgoogleoffindexUEFAEURO2016googleonindexOutsidersholdfirmondayofsurprises;

    @FindBy(className="dcm-title")
    public ILabel labelOutsidersholdfirmondayofsurprises;

    @FindBy(className="dcm-newsitemlink")
    public ILink linkgoogleoffindexCopaAmricaCentenariogoogleonindexArgentinastayperfectChileintolasteight;
    ...
    public ILink link3114008likes;

    @FindBy(className="social-channel-link")
    public ILink link8814174followers;

    @FindBy(className="social-channel-link")
    public ILink link1446571subscribers;

    @FindBy(className="title")
    public ILabel labelLiveScores;

    @FindBy(linkText=" Iceland Pepsi-deildin 2016      Latest Fixtures and ResultsLive now")
    public ILink linkIcelandPepsideildin2016LatestFixturesandResultsLivenow;
    ...
    @FindBy(className="flag ISL")
    public IImage imageFlagISL;

    @FindBy(className="ch-title")
    public ILabel labelPepsideildin2016;

    @FindBy(className="dcm-newsitemlink")
    public ILink linkgoogleoffindexTheWeekinNumbersgoogleonindexShocksshotsandasupersubgoogleoffindexWednesday15June2016googleonindex;

    @FindBy(className="dcm-title")
    public ILabel labelShocksshotsandasupersub1;

    @FindBy(linkText=" Belarus Belarusbank-Vysshaya Liga 2016      Latest Fixtures and ResultsLive now")
    public ILink linkBelarusBelarusbankVysshayaLiga2016LatestFixturesandResultsLivenow;
    ...
    @FindBy(className="flag BLR")
    public IImage imageFlagBLR;

    @FindBy(className="ch-title")
    public ILabel labelBelarusbankVysshayaLiga2016;

    @FindBy(className="dcm-newsitemlink")
    public ILink linkgoogleoffindexFIFAU17WomensWorldCupgoogleonindexGermanysEuropeantitledreamcomestruegoogleoffindexTuesday17May2016googleonindex;

    @FindBy(className="dcm-title")
    public ILabel labelGermanysEuropeantitledreamcomestrue;

    @FindBy(linkText=" Russia Rosgosstrakh Russian Football Championship 2015/2016 Latest Fixtures and ResultsLive now")
    public ILink linkRussiaRosgosstrakhRussianFootballChampionship20152016LatestFixturesandResultsLivenow;
    ...
    @FindBy(className="flag RUS")
    public IImage imageFlagRUS;

    @FindBy(className="ch-title")
    public ILabel labelRosgosstrakhRussianFootballChampionship20152016;

    @FindBy(className="dcm-newsitemlink")
    public ILink linkgoogleoffindexUEFAEURO2016googleonindexBaleboostsWalesEnglandheldgoogleoffindexSaturday11June2016googleonindex;

    @FindBy(className="dcm-title")
    public ILabel labelBaleboostsWalesEnglandheld;
    ...
    @FindBy(className="SVK i-4-flag flag")
    public IImage imageSVKi4flagflag;
